    ...
    if (in) {
        ...
        while (getline(in, line)) {
            ...
            while (getline(sep, datum, ',')) {
                ...
                /*
                stackoverflow.com/questions/49888882/c-determining-empty-cells-from-reading-in-data
                place the code here, update new .csv file but with empty cells instead of zeros, and do vec.emplace_back("0")
                */
            }
        }
    }
